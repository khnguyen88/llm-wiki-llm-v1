<!--
URL: https://openrouter.ai/docs/client-sdks/typescript/api-reference/responses.mdx
Download Date: 2026-04-29
Website: openrouter
Webpage: client-sdks-typescript-api-reference-responses
Index: 144
-->
...
| ---------------------- | ---------------------------------------------------------------------------------------------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`              | [operations.CreateResponsesRequest](/docs/sdks/typescript/api-reference/operations/createresponsesrequest) | :heavy\_check\_mark: | The request object to use for the request.                                                                                                                                     |
