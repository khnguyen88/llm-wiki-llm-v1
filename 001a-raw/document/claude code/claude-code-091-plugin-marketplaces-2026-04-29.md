...
On this page
  ...
  * [Optional fields](https://code.claude.com/docs/en/plugin-marketplaces#optional-fields)
  ...
  * [Pin dependency versions](https://code.claude.com/docs/en/plugin-marketplaces#pin-dependency-versions)
  * [Validation and testing](https://code.claude.com/docs/en/plugin-marketplaces#validation-and-testing)
  * [Manage marketplaces from the CLI](https://code.claude.com/docs/en/plugin-marketplaces#manage-marketplaces-from-the-cli)
  * [Plugin marketplace add](https://code.claude.com/docs/en/plugin-marketplaces#plugin-marketplace-add)
  * [Plugin marketplace list](https://code.claude.com/docs/en/plugin-marketplaces#plugin-marketplace-list)
  * [Plugin marketplace remove](https://code.claude.com/docs/en/plugin-marketplaces#plugin-marketplace-remove)
  * [Plugin marketplace update](https://code.claude.com/docs/en/plugin-marketplaces#plugin-marketplace-update)
  ...
  * [Marketplace updates fail in offline environments](https://code.claude.com/docs/en/plugin-marketplaces#marketplace-updates-fail-in-offline-environments)
...
## 
[​](https://code.claude.com/docs/en/plugin-marketplaces#overview)
Overview
...
Setting `version` means users only receive updates when you change this field, so bump it on every release. If you omit `version` and host this marketplace in git, every commit automatically counts as a new version. See [Version resolution](https://code.claude.com/docs/en/plugin-marketplaces#version-resolution-and-release-channels) to choose the right approach.
4
[](https://code.claude.com/docs/en/plugin-marketplaces)
...
## 
[​](https://code.claude.com/docs/en/plugin-marketplaces#create-the-marketplace-file)
Create the marketplace file
...
Marketplace schema
### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#required-fields)
Required fields  
...
### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#optional-fields)
Optional fields  
...
### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#required-fields-2)
Required fields  
| Field  | Type  | Description  |  
| --- | --- | --- |  
...
### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#optional-plugin-fields)
Optional plugin fields
**Standard metadata fields:**  
| Field  | Type  | Description  |  
| --- | --- | --- |  
| `description`  | string  | Brief plugin description  |  
| `version`  | string  | Plugin version. If set (here or in `plugin.json`), the plugin is pinned to this string and users only receive updates when it changes. Omit to fall back to the git commit SHA. See [Version resolution](https://code.claude.com/docs/en/plugin-marketplaces#version-resolution-and-release-channels).  |  
...
### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#git-repositories)
Git repositories
...
| `sha`  | string  | Optional. Full 40-character git commit SHA to pin to an exact version  |  
### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#npm-packages)
npm packages
...
### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#advanced-plugin-entries)
...
## 
[​](https://code.claude.com/docs/en/plugin-marketplaces#host-and-distribute-marketplaces)
Host and distribute marketplaces
### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#host-on-github-recommended)
...
### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#host-on-other-git-services)
...
### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#test-locally-before-distribution)
...
### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#require-marketplaces-for-your-team)
...
#### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#common-configurations)
...
#### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#how-restrictions-work)
...
#### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#set-up-release-channels)
...
#### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#pin-dependency-versions)
...
### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#plugin-marketplace-list)
...
| `--json`  | Output as JSON  |  
### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#plugin-marketplace-remove)
...
### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#plugin-marketplace-update)
...
### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#plugin-installation-failures)
...
### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#marketplace-updates-fail-in-offline-environments)
...
### 
[​](https://code.claude.com/docs/en/plugin-marketplaces#files-not-found-after-installation)
...
## 
[​](https://code.claude.com/docs/en/plugin-marketplaces#see-also)
See also
...
YesNo
[Track team usage with analytics](https://code.claude.com/docs/en/analytics)[Plugin dependency versions](https://code.claude.com/docs/en/plugin-dependencies)
Ctrl+I
[Claude Code Docs home page![light logo](https://mintcdn.com/claude-code/c5r9_6tjPMzFdDDT/logo/light.svg?fit=max&auto=format&n=c5r9_6tjPMzFdDDT&q=85&s=78fd01ff4f4340295a4f66e2ea54903c)![dark logo](https://mintcdn.com/claude-code/c5r9_6tjPMzFdDDT/logo/dark.svg?fit=max&auto=format&n=c5r9_6tjPMzFdDDT&q=85&s=1298a0c3b3a1da603b190d0de0e31712)](https://code.claude.com/docs/en/overview)
...
Terms and policies
[Privacy choices](https://code.claude.com/docs/en/plugin-marketplaces)[Privacy policy](https://www.anthropic.com/legal/privacy)[Disclosure policy](https://www.anthropic.com/responsible-disclosure-policy)[Usage policy](https://www.anthropic.com/legal/aup)[Commercial terms](https://www.anthropic.com/legal/commercial-terms)[Consumer terms](https://www.anthropic.com/legal/consumer-terms)
Assistant
