...
website: claude-code
webpage: champion-kit
-->

# Champion Kit

[Skip to main content](https://code.claude.com/docs/en/champion-kit#content-area)
...
On this page
  * [The champion role](https://code.claude.com/docs/en/champion-kit#the-champion-role)
  * [What this should cost you](https://code.claude.com/docs/en/champion-kit#what-this-should-cost-you)
  * [Share what you discover](https://code.claude.com/docs/en/champion-kit#share-what-you-discover)
  * [What is worth sharing](https://code.claude.com/docs/en/champion-kit#what-is-worth-sharing)
  * [Where to share it](https://code.claude.com/docs/en/champion-kit#where-to-share-it)
  * [The format that works](https://code.claude.com/docs/en/champion-kit#the-format-that-works)
  * [Be the person people ask](https://code.claude.com/docs/en/champion-kit#be-the-person-people-ask)
  * [Answer with a prompt rather than an explanation](https://code.claude.com/docs/en/champion-kit#answer-with-a-prompt-rather-than-an-explanation)
  * [Point at the feature rather than the documentation](https://code.claude.com/docs/en/champion-kit#point-at-the-feature-rather-than-the-documentation)
  * [Questions you are likely to hear](https://code.claude.com/docs/en/champion-kit#questions-you-are-likely-to-hear)
  * [Grow the circle](https://code.claude.com/docs/en/champion-kit#grow-the-circle)
  * [Patterns that tend to work](https://code.claude.com/docs/en/champion-kit#patterns-that-tend-to-work)
  * [Thirty-day playbook](https://code.claude.com/docs/en/champion-kit#thirty-day-playbook)
  * [When someone wants to go deeper](https://code.claude.com/docs/en/champion-kit#when-someone-wants-to-go-deeper)
  * [Respond to common concerns](https://code.claude.com/docs/en/champion-kit#respond-to-common-concerns)
  * [Quick-reference sheet](https://code.claude.com/docs/en/champion-kit#quick-reference-sheet)
...
## 
[​](https://code.claude.com/docs/en/champion-kit#the-champion-role)
The champion role
...
### 
[​](https://code.claude.com/docs/en/champion-kit#what-this-should-cost-you)
...
## 
[​](https://code.claude.com/docs/en/champion-kit#share-what-you-discover)
...
### 
[​](https://code.claude.com/docs/en/champion-kit#what-is-worth-sharing)
...
### 
[​](https://code.claude.com/docs/en/champion-kit#where-to-share-it)
Where to share it
...
### 
[​](https://code.claude.com/docs/en/champion-kit#the-format-that-works)
...
## 
[​](https://code.claude.com/docs/en/champion-kit#be-the-person-people-ask)
...
### 
[​](https://code.claude.com/docs/en/champion-kit#answer-with-a-prompt-rather-than-an-explanation)
...
### 
[​](https://code.claude.com/docs/en/champion-kit#point-at-the-feature-rather-than-the-documentation)
...
### 
[​](https://code.claude.com/docs/en/champion-kit#questions-you-are-likely-to-hear)
...
## 
[​](https://code.claude.com/docs/en/champion-kit#grow-the-circle)
Grow the circle
...
### 
[​](https://code.claude.com/docs/en/champion-kit#patterns-that-tend-to-work)
...
### 
[​](https://code.claude.com/docs/en/champion-kit#thirty-day-playbook)
Thirty-day playbook
...
Create the channel, pin the [Quickstart](https://code.claude.com/docs/en/quickstart), and post two or three of your own examples with the prompts included.**Signal that it is working:** a few colleagues react or reply, and at least one question is asked in the channel.
2
[](https://code.claude.com/docs/en/champion-kit)
...
### 
[​](https://code.claude.com/docs/en/champion-kit#when-someone-wants-to-go-deeper)
...
## 
[​](https://code.claude.com/docs/en/champion-kit#respond-to-common-concerns)
...
## 
[​](https://code.claude.com/docs/en/champion-kit#quick-reference-sheet)
...
Terms and policies
[Privacy choices](https://code.claude.com/docs/en/champion-kit)[Privacy policy](https://www.anthropic.com/legal/privacy)[Disclosure policy](https://www.anthropic.com/responsible-disclosure-policy)[Usage policy](https://www.anthropic.com/legal/aup)[Commercial terms](https://www.anthropic.com/legal/commercial-terms)[Consumer terms](https://www.anthropic.com/legal/consumer-terms)
Assistant
