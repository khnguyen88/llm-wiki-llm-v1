...
## 
[​](https://code.claude.com/docs/en/agent-sdk/user-input#handle-tool-approval-requests)
...
### 
[​](https://code.claude.com/docs/en/agent-sdk/user-input#question-format)
Question format
...
#### 
[​](https://code.claude.com/docs/en/agent-sdk/user-input#option-previews-typescript)
...
### 
[​](https://code.claude.com/docs/en/agent-sdk/user-input#response-format)
Response format
...
#### 
[​](https://code.claude.com/docs/en/agent-sdk/user-input#support-free-text-input)
...
### 
[​](https://code.claude.com/docs/en/agent-sdk/user-input#complete-example)
Complete example
...
## 
[​](https://code.claude.com/docs/en/agent-sdk/user-input#other-ways-to-get-user-input)
...
### 
[​](https://code.claude.com/docs/en/agent-sdk/user-input#streaming-input)
Streaming input
...
### 
[​](https://code.claude.com/docs/en/agent-sdk/user-input#custom-tools)
Custom tools
...
## 
[​](https://code.claude.com/docs/en/agent-sdk/user-input#related-resources)
Related resources
...
Terms and policies
[Privacy choices](https://code.claude.com/docs/en/agent-sdk/user-input)[Privacy policy](https://www.anthropic.com/legal/privacy)[Disclosure policy](https://www.anthropic.com/responsible-disclosure-policy)[Usage policy](https://www.anthropic.com/legal/aup)[Commercial terms](https://www.anthropic.com/legal/commercial-terms)[Consumer terms](https://www.anthropic.com/legal/consumer-terms)
Assistant
