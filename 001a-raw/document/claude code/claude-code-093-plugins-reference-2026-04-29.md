...
On this page
  ...
  * [plugin prune](https://code.claude.com/docs/en/plugins-reference#plugin-prune)
  ...
  * [plugin list](https://code.claude.com/docs/en/plugins-reference#plugin-list)
  * [plugin tag](https://code.claude.com/docs/en/plugins-reference#plugin-tag)
...
The `command` value supports the same [variable substitutions](https://code.claude.com/docs/en/plugins-reference#environment-variables) as MCP and LSP server configs: `${CLAUDE_PLUGIN_ROOT}`, `${CLAUDE_PLUGIN_DATA}`, `${user_config.*}`, and any `${ENV_VAR}` from the environment. Prefix the command with `cd "${CLAUDE_PLUGIN_ROOT}" && ` if the script needs to run from the plugin’s own directory. Disabling a plugin mid-session does not stop monitors that are already running. They stop when the session ends.
### 
[​](https://code.claude.com/docs/en/plugins-reference#themes)
Themes
...
| `themes`  | string|array  | Color theme files/directories (replaces default `themes/`). See [Themes](https://code.claude.com/docs/en/plugins-reference#themes)  | `"./themes/"`  |  
...
| `monitors`  | string|array  | Background [Monitor](https://code.claude.com/docs/en/tools-reference#monitor-tool) configurations that start automatically when the plugin is active. See [Monitors](https://code.claude.com/docs/en/plugins-reference#monitors)  | `"./monitors.json"`  |  
...
| `--prune`  | Also remove auto-installed dependencies that no other plugin requires. See [plugin prune](https://code.claude.com/docs/en/plugins-reference#plugin-prune)  |   |  
...
### 
[​](https://code.claude.com/docs/en/plugins-reference#plugin-prune)
plugin prune
...
| `-h, --help`  | Display help for command  |   |  
### 
[​](https://code.claude.com/docs/en/plugins-reference#plugin-tag)
plugin tag
Create a release git tag for the plugin in the current directory. Run from inside the plugin’s folder. See [Tag plugin releases](https://code.claude.com/docs/en/plugin-dependencies#tag-plugin-releases-for-version-resolution).
...
Terms and policies
[Privacy choices](https://code.claude.com/docs/en/plugins-reference)[Privacy policy](https://www.anthropic.com/legal/privacy)[Disclosure policy](https://www.anthropic.com/responsible-disclosure-policy)[Usage policy](https://www.anthropic.com/legal/aup)[Commercial terms](https://www.anthropic.com/legal/commercial-terms)[Consumer terms](https://www.anthropic.com/legal/consumer-terms)
Assistant
