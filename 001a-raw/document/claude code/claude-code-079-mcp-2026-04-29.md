...
On this page
  ...
  * [Automatic reconnection](https://code.claude.com/docs/en/mcp#automatic-reconnection)
  ...
  * [Restrict OAuth scopes](https://code.claude.com/docs/en/mcp#restrict-oauth-scopes)
  ...
  * [Raise the limit for a specific tool](https://code.claude.com/docs/en/mcp#raise-the-limit-for-a-specific-tool)
  ...
  * [Exempt a server from deferral](https://code.claude.com/docs/en/mcp#exempt-a-server-from-deferral)
...
Terms and policies
[Privacy choices](https://code.claude.com/docs/en/mcp)[Privacy policy](https://www.anthropic.com/legal/privacy)[Disclosure policy](https://www.anthropic.com/responsible-disclosure-policy)[Usage policy](https://www.anthropic.com/legal/aup)[Commercial terms](https://www.anthropic.com/legal/commercial-terms)[Consumer terms](https://www.anthropic.com/legal/consumer-terms)
Assistant
