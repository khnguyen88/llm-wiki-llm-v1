...
**Claude Opus 4.7 is now available.** Claude Code GitHub Actions default to Sonnet. To use Opus 4.7, configure the [model parameter](https://code.claude.com/docs/en/github-actions#breaking-changes-reference) to use `claude-opus-4-7`.
## 
...
## 
[​](https://code.claude.com/docs/en/github-actions#using-with-aws-bedrock-&-google-vertex-ai)
...
#### 
[​](https://code.claude.com/docs/en/github-actions#for-google-cloud-vertex-ai)
...
#### 
[​](https://code.claude.com/docs/en/github-actions#for-aws-bedrock)
For AWS Bedrock:
...
Terms and policies
[Privacy choices](https://code.claude.com/docs/en/github-actions)[Privacy policy](https://www.anthropic.com/legal/privacy)[Disclosure policy](https://www.anthropic.com/responsible-disclosure-policy)[Usage policy](https://www.anthropic.com/legal/aup)[Commercial terms](https://www.anthropic.com/legal/commercial-terms)[Consumer terms](https://www.anthropic.com/legal/consumer-terms)
Assistant
