...
- Conditional `if` hooks (introduced in Week 13, v2.1.85) allow hooks to execute only when a specified condition is met, using permission rule syntax; e.g., a pre-commit check scoped to `Bash(git commit *)` fires only for git commits, reducing process overhead on busy sessions ^[raw/document/claude code/claude-code-117-whats-new-2026-04-29.md] ^[raw/document/claude code/claude-code-118-whats-new-2026-w13-2026-04-29.md]
