...
A full-stack observability platform for monitoring applications, infrastructure, and digital experiences. It is available as a [[004-wiki/concepts/broadcast|Broadcast]] destination on [[004-wiki/entities/openrouter|OpenRouter]], receiving LLM traces via the [[004-wiki/entities/open_telemetry|OpenTelemetry]] OTLP protocol. ^[001a-raw/document/openrouter/openrouter-058-guides-features-broadcast-newrelic-2026-04-29.md]
