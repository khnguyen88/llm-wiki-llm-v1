...
- Exacto differs from [[004-wiki/concepts/auto-exacto]] in that it is opt-in via the `:exacto` suffix, whereas Auto Exacto runs automatically on tool-calling requests ^[001a-raw/document/openrouter/openrouter-022-guides-routing-model-variants-exacto-2026-04-29.md]
