---
title: "Openrouter Guides Routing Model Variants Thinking"
summary: "The :thinking variant on OpenRouter enables extended reasoning and chain-of-thought capabilities by appending :thinking to a model ID"
type: summary
sources:
...
# Openrouter Guides Routing Model Variants Thinking
...
- The source document is brief (~95 words) and focuses on the mechanism and use case; detailed configuration of reasoning tokens is covered separately in the Reasoning Tokens documentation.
