...
> "One of the first challenges of working with large language models (LLMs) is understanding their names." ^[001a-raw/articles/How to navigate LLM model names.md:12]

> "Instruct models are one of the most common model types you will encounter, and if you are looking for a conversational model this is most likely what you want." ^[001a-raw/articles/How to navigate LLM model names.md:53-54]

> "Quantization is the process of converting a model weights from high precision data types such as 32-bit or 16-bit floating point numbers to lower precision types such as 8-bit floating point or integer values." ^[001a-raw/articles/How to navigate LLM model names.md:84-85]
