...
- Deleted wiki/ content and rebuilt from sources
...
## [2026-05-18] process | Unsupervised_Learning_Method_for_Plant_and_Leaf_Segmentation.pdf → 4 segments in processed/papers/
...
- Source: raw/document/claude code/claude-code-001-admin-setup-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-002-agent-sdk-agent-loop-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-003-agent-sdk-claude-code-features-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-004-agent-sdk-cost-tracking-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-005-agent-sdk-custom-tools-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-006-agent-sdk-file-checkpointing-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-007-agent-sdk-hooks-2026-04-29.md
- Created summary: summaries/claude-code-agent-sdk-hooks.md
- Updated index.md, sources-manifest.md
- Cost: $4.2305

## [2026-05-01] ingest | Claude Code Agent Sdk Hosting
- Source: raw/document/claude code/claude-code-008-agent-sdk-hosting-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-009-agent-sdk-mcp-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-010-agent-sdk-migration-guide-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-011-agent-sdk-modifying-system-prompts-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-012-agent-sdk-observability-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-013-agent-sdk-overview-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-014-agent-sdk-permissions-2026-04-29.md
- Created summary: summaries/claude-code-agent-sdk-permissions.md
- Updated index.md, sources-manifest.md
- Cost: $3.1407

## [2026-05-01] ingest | Claude Code Agent Sdk Plugins
- Source: raw/document/claude code/claude-code-015-agent-sdk-plugins-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-017-agent-sdk-quickstart-2026-04-29.md
- Created summary: summaries/claude-code-agent-sdk-quickstart.md
- Updated index.md, sources-manifest.md
- Cost: $4.1782

## [2026-05-01] ingest | Claude Code Agent Sdk Secure Deployment
- Source: raw/document/claude code/claude-code-018-agent-sdk-secure-deployment-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-019-agent-sdk-sessions-2026-04-29.md
- Created summary: summaries/claude-code-agent-sdk-sessions.md
- Updated index.md, sources-manifest.md
- Cost: $1.6525

## [2026-05-01] ingest | Claude Code Agent Sdk Skills
- Source: raw/document/claude code/claude-code-020-agent-sdk-skills-2026-04-29.md
- Created summary: summaries/claude-code-agent-sdk-skills.md
- Updated index.md, sources-manifest.md
- Cost: $4.2313

## [2026-05-01] ingest | Claude Code Agent Sdk Slash Commands
- Source: raw/document/claude code/claude-code-021-agent-sdk-slash-commands-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-022-agent-sdk-streaming-output-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-023-agent-sdk-streaming-vs-single-mode-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-024-agent-sdk-structured-outputs-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-025-agent-sdk-subagents-2026-04-29.md
- Created summary: summaries/claude-code-agent-sdk-subagents.md
- Updated index.md, sources-manifest.md
- Cost: $5.6437

## [2026-05-01] ingest | Claude Code Agent Sdk Todo Tracking
- Source: raw/document/claude code/claude-code-026-agent-sdk-todo-tracking-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-027-agent-sdk-tool-search-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-031-agent-teams-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-033-analytics-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-034-authentication-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-035-auto-mode-config-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-037-champion-kit-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-039-channels-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-040-channels-reference-2026-04-29.md
- Created summary: summaries/claude-code-channels-reference.md
- Updated index.md, sources-manifest.md
- Cost: $8.8021

## [2026-05-01] ingest | Claude Code Checkpointing
- Source: raw/document/claude code/claude-code-041-checkpointing-2026-04-29.md
- Created summary: summaries/claude-code-checkpointing.md
- Updated index.md, sources-manifest.md
- Cost: $0.7338

## [2026-05-01] ingest | Claude Code Chrome
- Source: raw/document/claude code/claude-code-042-chrome-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-043-claude-code-on-the-web-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-044-claude-directory-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-046-code-review-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-047-commands-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-048-common-workflows-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-049-communications-kit-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-050-computer-use-2026-04-29.md
...
- Source: raw/document/claude code/claude-code-051-context-window-2026-04-29.md
