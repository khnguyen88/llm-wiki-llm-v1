...
When combined with `partition: "none"` in the `sort` object and [[004-wiki/concepts/model-fallback]], performance thresholds can select the cheapest or fastest endpoint across multiple models. ^[001a-raw/document/openrouter/openrouter-018-guides-routing-provider-selection-2026-04-29.md]
