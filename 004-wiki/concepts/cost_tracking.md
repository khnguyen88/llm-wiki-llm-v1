...
- Workspace spend limits can be set on the total Claude Code workspace spend via the [[004-wiki/entities/claude_console|Claude Console]]; admins can view cost and usage reporting in the Console ^[raw/document/claude code/claude-code-052-costs-2026-04-29.md]
- On Bedrock, Vertex, and Foundry deployments, Claude Code does not send metrics from the cloud; [[004-wiki/entities/litellm|LiteLLM]] is an open-source alternative for tracking spend by key on those platforms ^[raw/document/claude code/claude-code-052-costs-2026-04-29.md]
...
- `/cost` now shows a per-model and cache-hit breakdown for subscription users (Week 15, v2.1.92-101) ^[raw/document/claude code/claude-code-120-whats-new-2026-w15-2026-04-29.md]
