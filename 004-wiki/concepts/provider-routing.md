...
- `partition: "none"` in the `sort` object removes model-grouped ordering, allowing cross-model sorting for use with [[004-wiki/concepts/model-fallback]] ^[001a-raw/document/openrouter/openrouter-018-guides-routing-provider-selection-2026-04-29.md]
- For tool-calling requests, [[004-wiki/concepts/auto-exacto]] overrides price-weighted routing by reordering providers based on throughput, tool-calling success rate, and benchmark performance ^[001a-raw/document/openrouter/openrouter-019-guides-routing-auto-exacto-2026-04-29.md]
