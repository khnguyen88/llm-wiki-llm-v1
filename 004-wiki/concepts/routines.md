...
- Routines are created on Claude Code on the web and run on Anthropic-managed infrastructure, not the user's local machine ^[001a-raw/document/claude code/claude-code-121-whats-new-2026-w16-2026-04-29.md]
- Three trigger types: scheduled (cron-style timing), GitHub events (with optional filters), and API calls via a tokened `/fire` endpoint ^[001a-raw/document/claude code/claude-code-121-whats-new-2026-w16-2026-04-29.md]
- GitHub event triggers include `PR-opened` and `release-published`, with optional filters to scope which events actually fire the routine ^[001a-raw/document/claude code/claude-code-121-whats-new-2026-w16-2026-04-29.md]
- Each routine receives a unique tokened `/fire` endpoint that external systems can call to trigger execution ^[001a-raw/document/claude code/claude-code-121-whats-new-2026-w16-2026-04-29.md]
- Routines can be scaffolded from the terminal using `/schedule` (e.g., `/schedule daily PR review at 9am`) ^[001a-raw/document/claude code/claude-code-121-whats-new-2026-w16-2026-04-29.md]
