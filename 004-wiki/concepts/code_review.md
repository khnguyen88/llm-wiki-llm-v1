...
- Code Review posts findings as inline GitHub comments on the PR itself, unlike [[004-wiki/concepts/ultrareview|ultrareview]] which returns findings in the CLI session ^[raw/document/claude code/claude-code-113-ultrareview-2026-04-29.md]
