...
- Skills are discovered from the filesystem through [[004-wiki/concepts/setting_sources|settingSources]]; with default options, user and project skills load automatically ^[raw/document/claude code/claude-code-003-agent-sdk-claude-code-features-2026-04-29.md]
