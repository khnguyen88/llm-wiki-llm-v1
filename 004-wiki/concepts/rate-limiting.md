...
For example, a 200-user organization might request 20k TPM per user, or 4 million total TPM (200 x 20,000). The workspace rate limit can be configured on the workspace's Limits page in the [[004-wiki/entities/claude-console|Claude Console]]. ^[001a-raw/document/claude code/claude-code-052-costs-2026-04-29.md]
