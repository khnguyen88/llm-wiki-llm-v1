...
- `--json-schema` constrains print-mode output to a specified JSON Schema; the agent completes its workflow and returns validated structured output (see [[004-wiki/concepts/structured_output]]) ^[raw/document/claude code/claude-code-045-cli-reference-2026-04-29.md]
...
- `--bare` skips auto-discovery of hooks, skills, plugins, MCP servers, auto memory, and CLAUDE.md for faster scripted startup; only Bash, Read, and Edit tools are available (see [[004-wiki/concepts/bare_mode]]) ^[raw/document/claude code/claude-code-045-cli-reference-2026-04-29.md]
