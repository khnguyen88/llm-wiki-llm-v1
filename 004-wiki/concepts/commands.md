...
- Custom commands are created through [[004-wiki/concepts/skills|skills]] at `.claude/skills/<name>/SKILL.md` ^[raw/document/claude code/claude-code-047-commands-2026-04-29.md]
