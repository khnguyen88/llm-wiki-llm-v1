...
Ultrareview is a deep code review feature that launches a fleet of reviewer agents in a [[004-wiki/entities/claude-code-web|cloud sandbox]] to find bugs in a branch or pull request. Unlike the local `/review` command, ultrareview independently reproduces and verifies every finding so results focus on real bugs rather than style suggestions. The feature is a public research preview available in Claude Code v2.1.86 and later. ^[001a-raw/document/claude code/claude-code-113-ultrareview-2026-04-29.md] ^[001a-raw/document/claude code/claude-code-117-whats-new-2026-04-29.md]
