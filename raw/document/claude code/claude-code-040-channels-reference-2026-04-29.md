...
## 
[​](https://code.claude.com/docs/en/channels-reference#overview)
Overview
...
## 
[​](https://code.claude.com/docs/en/channels-reference#what-you-need)
What you need
...
### 
[​](https://code.claude.com/docs/en/channels-reference#how-relay-works)
How relay works
...
### 
[​](https://code.claude.com/docs/en/channels-reference#permission-request-fields)
...
### 
[​](https://code.claude.com/docs/en/channels-reference#add-relay-to-a-chat-bridge)
...
### 
[​](https://code.claude.com/docs/en/channels-reference#full-example)
Full example
...
## 
[​](https://code.claude.com/docs/en/channels-reference#package-as-a-plugin)
Package as a plugin
...
## 
[​](https://code.claude.com/docs/en/channels-reference#see-also)
See also
...
YesNo
[Plugins reference](https://code.claude.com/docs/en/plugins-reference)[Glossary](https://code.claude.com/docs/en/glossary)
Ctrl+I
[Claude Code Docs home page![light logo](https://mintcdn.com/claude-code/c5r9_6tjPMzFdDDT/logo/light.svg?fit=max&auto=format&n=c5r9_6tjPMzFdDDT&q=85&s=78fd01ff4f4340295a4f66e2ea54903c)![dark logo](https://mintcdn.com/claude-code/c5r9_6tjPMzFdDDT/logo/dark.svg?fit=max&auto=format&n=c5r9_6tjPMzFdDDT&q=85&s=1298a0c3b3a1da603b190d0de0e31712)](https://code.claude.com/docs/en/overview)
...
Terms and policies
[Privacy choices](https://code.claude.com/docs/en/channels-reference)[Privacy policy](https://www.anthropic.com/legal/privacy)[Disclosure policy](https://www.anthropic.com/responsible-disclosure-policy)[Usage policy](https://www.anthropic.com/legal/aup)[Commercial terms](https://www.anthropic.com/legal/commercial-terms)[Consumer terms](https://www.anthropic.com/legal/consumer-terms)
Assistant
