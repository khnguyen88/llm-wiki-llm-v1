...
website: claude-code
webpage: communications-kit
-->

# Communications Kit

[Skip to main content](https://code.claude.com/docs/en/communications-kit#content-area)
...
On this page
  * [Launch communications](https://code.claude.com/docs/en/communications-kit#launch-communications)
  * [Before you send](https://code.claude.com/docs/en/communications-kit#before-you-send)
  * [The announcement](https://code.claude.com/docs/en/communications-kit#the-announcement)
  * [Executive sponsor variant](https://code.claude.com/docs/en/communications-kit#executive-sponsor-variant)
  * [Pilot group variant](https://code.claude.com/docs/en/communications-kit#pilot-group-variant)
  * [Champion recruitment DM](https://code.claude.com/docs/en/communications-kit#champion-recruitment-dm)
  * [Tips and tricks campaign](https://code.claude.com/docs/en/communications-kit#tips-and-tricks-campaign)
  * [Get started](https://code.claude.com/docs/en/communications-kit#get-started)
  * [Project memory](https://code.claude.com/docs/en/communications-kit#project-memory)
  * [Control and safety](https://code.claude.com/docs/en/communications-kit#control-and-safety)
  * [Connect your tools](https://code.claude.com/docs/en/communications-kit#connect-your-tools)
  * [Automate your workflows](https://code.claude.com/docs/en/communications-kit#automate-your-workflows)
  * [Day-to-day development](https://code.claude.com/docs/en/communications-kit#day-to-day-development)
  * [Share and scale](https://code.claude.com/docs/en/communications-kit#share-and-scale)
  * [Security and admin](https://code.claude.com/docs/en/communications-kit#security-and-admin)
  * [Quick reference](https://code.claude.com/docs/en/communications-kit#quick-reference)
  * [FAQ responses](https://code.claude.com/docs/en/communications-kit#faq-responses)
  * [Prompt templates](https://code.claude.com/docs/en/communications-kit#prompt-templates)
...
## 
[​](https://code.claude.com/docs/en/communications-kit#launch-communications)
...
### 
[​](https://code.claude.com/docs/en/communications-kit#before-you-send)
Before you send
...
### 
[​](https://code.claude.com/docs/en/communications-kit#the-announcement)
The announcement
...
### 
[​](https://code.claude.com/docs/en/communications-kit#executive-sponsor-variant)
...
### 
[​](https://code.claude.com/docs/en/communications-kit#pilot-group-variant)
Pilot group variant
...
### 
[​](https://code.claude.com/docs/en/communications-kit#champion-recruitment-dm)
...
## 
[​](https://code.claude.com/docs/en/communications-kit#tips-and-tricks-campaign)
...
### 
[​](https://code.claude.com/docs/en/communications-kit#get-started)
Get started
...
### 
[​](https://code.claude.com/docs/en/communications-kit#project-memory)
Project memory
**`/init`and CLAUDE.md**
...
### 
[​](https://code.claude.com/docs/en/communications-kit#control-and-safety)
Control and safety
**Permission modes**
...
### 
[​](https://code.claude.com/docs/en/communications-kit#connect-your-tools)
Connect your tools
**MCP connectors**
...
### 
[​](https://code.claude.com/docs/en/communications-kit#automate-your-workflows)
...
### 
[​](https://code.claude.com/docs/en/communications-kit#day-to-day-development)
...
### 
[​](https://code.claude.com/docs/en/communications-kit#share-and-scale)
Share and scale
**Plugins**
...
### 
[​](https://code.claude.com/docs/en/communications-kit#security-and-admin)
Security and admin
...
## 
[​](https://code.claude.com/docs/en/communications-kit#quick-reference)
Quick reference
### 
[​](https://code.claude.com/docs/en/communications-kit#faq-responses)
FAQ responses
...
### 
[​](https://code.claude.com/docs/en/communications-kit#prompt-templates)
Prompt templates
...
YesNo
[Zero data retention](https://code.claude.com/docs/en/zero-data-retention)[Champion kit](https://code.claude.com/docs/en/champion-kit)
⌘I
[Claude Code Docs home page![light logo](https://mintcdn.com/claude-code/c5r9_6tjPMzFdDDT/logo/light.svg?fit=max&auto=format&n=c5r9_6tjPMzFdDDT&q=85&s=78fd01ff4f4340295a4f66e2ea54903c)![dark logo](https://mintcdn.com/claude-code/c5r9_6tjPMzFdDDT/logo/dark.svg?fit=max&auto=format&n=c5r9_6tjPMzFdDDT&q=85&s=1298a0c3b3a1da603b190d0de0e31712)](https://code.claude.com/docs/en/overview)
