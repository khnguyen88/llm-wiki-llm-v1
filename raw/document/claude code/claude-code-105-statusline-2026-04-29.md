...
## 
[​](https://code.claude.com/docs/en/statusline#set-up-a-status-line)
...
### 
[​](https://code.claude.com/docs/en/statusline#use-the-/statusline-command)
...
### 
[​](https://code.claude.com/docs/en/statusline#disable-the-status-line)
...
Running [`/statusline`](https://code.claude.com/docs/en/statusline#use-the-%2Fstatusline-command) with a description of what you want configures all of this for you automatically.
...
## 
[​](https://code.claude.com/docs/en/statusline#examples)
Examples
...
### 
[​](https://code.claude.com/docs/en/statusline#git-status-with-colors)
...
### 
[​](https://code.claude.com/docs/en/statusline#cost-and-duration-tracking)
...
### 
[​](https://code.claude.com/docs/en/statusline#clickable-links)
Clickable links
...
### 
[​](https://code.claude.com/docs/en/statusline#windows-configuration)
...
## 
[​](https://code.claude.com/docs/en/statusline#tips)
Tips
...
## 
[​](https://code.claude.com/docs/en/statusline#troubleshooting)
Troubleshooting
...
YesNo
[Voice dictation](https://code.claude.com/docs/en/voice-dictation)[Customize keyboard shortcuts](https://code.claude.com/docs/en/keybindings)
⌘I
[Claude Code Docs home page![light logo](https://mintcdn.com/claude-code/c5r9_6tjPMzFdDDT/logo/light.svg?fit=max&auto=format&n=c5r9_6tjPMzFdDDT&q=85&s=78fd01ff4f4340295a4f66e2ea54903c)![dark logo](https://mintcdn.com/claude-code/c5r9_6tjPMzFdDDT/logo/dark.svg?fit=max&auto=format&n=c5r9_6tjPMzFdDDT&q=85&s=1298a0c3b3a1da603b190d0de0e31712)](https://code.claude.com/docs/en/overview)
