...
On this page
  ...
  * [Sign in with Bedrock](https://code.claude.com/docs/en/amazon-bedrock#sign-in-with-bedrock)
  * [Set up manually](https://code.claude.com/docs/en/amazon-bedrock#set-up-manually)
  ...
  * [Startup model checks](https://code.claude.com/docs/en/amazon-bedrock#startup-model-checks)
  * [IAM configuration](https://code.claude.com/docs/en/amazon-bedrock#iam-configuration)
  * [1M token context window](https://code.claude.com/docs/en/amazon-bedrock#1m-token-context-window)
  * [Service tiers](https://code.claude.com/docs/en/amazon-bedrock#service-tiers)
  * [AWS Guardrails](https://code.claude.com/docs/en/amazon-bedrock#aws-guardrails)
  * [Use the Mantle endpoint](https://code.claude.com/docs/en/amazon-bedrock#use-the-mantle-endpoint)
  * [Enable Mantle](https://code.claude.com/docs/en/amazon-bedrock#enable-mantle)
  * [Select a Mantle model](https://code.claude.com/docs/en/amazon-bedrock#select-a-mantle-model)
  * [Run Mantle alongside the Invoke API](https://code.claude.com/docs/en/amazon-bedrock#run-mantle-alongside-the-invoke-api)
  * [Route Mantle through a gateway](https://code.claude.com/docs/en/amazon-bedrock#route-mantle-through-a-gateway)
  * [Mantle environment variables](https://code.claude.com/docs/en/amazon-bedrock#mantle-environment-variables)
  * [Troubleshooting](https://code.claude.com/docs/en/amazon-bedrock#troubleshooting)
  * [Authentication loop with SSO and corporate proxies](https://code.claude.com/docs/en/amazon-bedrock#authentication-loop-with-sso-and-corporate-proxies)
  * [Region issues](https://code.claude.com/docs/en/amazon-bedrock#region-issues)
  * [Mantle endpoint errors](https://code.claude.com/docs/en/amazon-bedrock#mantle-endpoint-errors)
...
## 
[​](https://code.claude.com/docs/en/amazon-bedrock#prerequisites)
Prerequisites
...
To sign in with your own Bedrock credentials, follow [Sign in with Bedrock](https://code.claude.com/docs/en/amazon-bedrock#sign-in-with-bedrock) below. To deploy Claude Code across a team, use the [manual setup](https://code.claude.com/docs/en/amazon-bedrock#set-up-manually) steps and [pin your model versions](https://code.claude.com/docs/en/amazon-bedrock#4-pin-model-versions) before rolling out.
## 
...
In the [Amazon Bedrock console](https://console.aws.amazon.com/bedrock/), open the Model catalog, select an Anthropic model, and submit the use case form. Access is granted immediately after submission. See [Submit use case details](https://code.claude.com/docs/en/amazon-bedrock#1-submit-use-case-details) for AWS Organizations and [IAM configuration](https://code.claude.com/docs/en/amazon-bedrock#iam-configuration) for the permissions your role needs.
2
[](https://code.claude.com/docs/en/amazon-bedrock)
...
## 
[​](https://code.claude.com/docs/en/amazon-bedrock#set-up-manually)
Set up manually
...
### 
[​](https://code.claude.com/docs/en/amazon-bedrock#1-submit-use-case-details)
...
### 
[​](https://code.claude.com/docs/en/amazon-bedrock#2-configure-aws-credentials)
...
#### 
[​](https://code.claude.com/docs/en/amazon-bedrock#map-each-model-version-to-an-inference-profile)
...
## 
[​](https://code.claude.com/docs/en/amazon-bedrock#startup-model-checks)
Startup model checks
When Claude Code starts with Bedrock configured, it verifies that the models it intends to use are accessible in your account. This check requires Claude Code v2.1.94 or later. If you have pinned a model version that is older than the current Claude Code default, and your account can invoke the newer version, Claude Code prompts you to update the pin. Accepting writes the new model ID to your [user settings file](https://code.claude.com/docs/en/settings) and restarts Claude Code. Declining is remembered until the next default version change. Pins that point to an [application inference profile ARN](https://code.claude.com/docs/en/amazon-bedrock#map-each-model-version-to-an-inference-profile) are skipped, since those are managed by your administrator. If you have not pinned a model and the current default is unavailable in your account, Claude Code falls back to the previous version for the current session and shows a notice. The fallback is not persisted. Enable the newer model in your Bedrock account or [pin a version](https://code.claude.com/docs/en/amazon-bedrock#4-pin-model-versions) to make the choice permanent.
## 
...
## 
[​](https://code.claude.com/docs/en/amazon-bedrock#aws-guardrails)
AWS Guardrails
...
### 
[​](https://code.claude.com/docs/en/amazon-bedrock#enable-mantle)
Enable Mantle
...
### 
[​](https://code.claude.com/docs/en/amazon-bedrock#select-a-mantle-model)
...
### 
[​](https://code.claude.com/docs/en/amazon-bedrock#run-mantle-alongside-the-invoke-api)
...
### 
[​](https://code.claude.com/docs/en/amazon-bedrock#route-mantle-through-a-gateway)
...
### 
[​](https://code.claude.com/docs/en/amazon-bedrock#mantle-environment-variables)
...
## 
[​](https://code.claude.com/docs/en/amazon-bedrock#troubleshooting)
Troubleshooting
### 
[​](https://code.claude.com/docs/en/amazon-bedrock#authentication-loop-with-sso-and-corporate-proxies)
...
### 
[​](https://code.claude.com/docs/en/amazon-bedrock#region-issues)
Region issues
...
Terms and policies
[Privacy choices](https://code.claude.com/docs/en/amazon-bedrock)[Privacy policy](https://www.anthropic.com/legal/privacy)[Disclosure policy](https://www.anthropic.com/responsible-disclosure-policy)[Usage policy](https://www.anthropic.com/legal/aup)[Commercial terms](https://www.anthropic.com/legal/commercial-terms)[Consumer terms](https://www.anthropic.com/legal/consumer-terms)
Assistant
