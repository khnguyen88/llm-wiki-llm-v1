...
On this page
  * [Access analytics for Team and Enterprise](https://code.claude.com/docs/en/analytics#access-analytics-for-team-and-enterprise)
...
| --- | --- | --- | --- |  
| Claude for Teams / Enterprise  | [claude.ai/analytics/claude-code](https://claude.ai/analytics/claude-code)  | Usage metrics, contribution metrics with GitHub integration, leaderboard, data export  | [Details](https://code.claude.com/docs/en/analytics#access-analytics-for-team-and-enterprise)  |  
...
## 
[​](https://code.claude.com/docs/en/analytics#access-analytics-for-team-and-enterprise)
...
### 
[​](https://code.claude.com/docs/en/analytics#enable-contribution-metrics)
...
### 
[​](https://code.claude.com/docs/en/analytics#review-summary-metrics)
...
### 
[​](https://code.claude.com/docs/en/analytics#explore-the-charts)
Explore the charts
The dashboard includes several charts to visualize trends over time.
#### 
[​](https://code.claude.com/docs/en/analytics#track-adoption)
Track adoption
...
#### 
[​](https://code.claude.com/docs/en/analytics#measure-prs-per-user)
...
#### 
[​](https://code.claude.com/docs/en/analytics#view-pull-requests-breakdown)
...
#### 
[​](https://code.claude.com/docs/en/analytics#find-top-contributors)
...
### 
[​](https://code.claude.com/docs/en/analytics#pr-attribution)
PR attribution
...
#### 
[​](https://code.claude.com/docs/en/analytics#tagging-criteria)
Tagging criteria
...
#### 
[​](https://code.claude.com/docs/en/analytics#attribution-process)
Attribution process
...
#### 
[​](https://code.claude.com/docs/en/analytics#time-window)
Time window
Sessions from 21 days before to 2 days after the PR merge date are considered for attribution matching.
#### 
[​](https://code.claude.com/docs/en/analytics#excluded-files)
Excluded files
...
#### 
[​](https://code.claude.com/docs/en/analytics#attribution-notes)
Attribution notes
...
### 
[​](https://code.claude.com/docs/en/analytics#get-the-most-from-analytics)
...
#### 
[​](https://code.claude.com/docs/en/analytics#monitor-adoption)
Monitor adoption
...
#### 
[​](https://code.claude.com/docs/en/analytics#measure-roi)
Measure ROI
...
#### 
[​](https://code.claude.com/docs/en/analytics#identify-power-users)
...
#### 
[​](https://code.claude.com/docs/en/analytics#access-data-programmatically)
Access data programmatically
To query this data through GitHub, search for PRs labeled with `claude-code-assisted`.
## 
[​](https://code.claude.com/docs/en/analytics#access-analytics-for-api-customers)
...
### 
[​](https://code.claude.com/docs/en/analytics#view-team-insights)
View team insights
...
## 
[​](https://code.claude.com/docs/en/analytics#related-resources)
Related resources
...
Terms and policies
[Privacy choices](https://code.claude.com/docs/en/analytics)[Privacy policy](https://www.anthropic.com/legal/privacy)[Disclosure policy](https://www.anthropic.com/responsible-disclosure-policy)[Usage policy](https://www.anthropic.com/legal/aup)[Commercial terms](https://www.anthropic.com/legal/commercial-terms)[Consumer terms](https://www.anthropic.com/legal/consumer-terms)
Assistant
