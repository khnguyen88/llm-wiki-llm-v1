...
website: claude-code
webpage: claude-code-on-the-web
-->
...
On this page
  ...
  * [The cloud environment](https://code.claude.com/docs/en/claude-code-on-the-web#the-cloud-environment)
  * [What’s available in cloud sessions](https://code.claude.com/docs/en/claude-code-on-the-web#what%E2%80%99s-available-in-cloud-sessions)
  * [Installed tools](https://code.claude.com/docs/en/claude-code-on-the-web#installed-tools)
  * [Work with GitHub issues and pull requests](https://code.claude.com/docs/en/claude-code-on-the-web#work-with-github-issues-and-pull-requests)
  * [Link artifacts back to the session](https://code.claude.com/docs/en/claude-code-on-the-web#link-artifacts-back-to-the-session)
  * [Run tests, start services, and add packages](https://code.claude.com/docs/en/claude-code-on-the-web#run-tests-start-services-and-add-packages)
  * [Resource limits](https://code.claude.com/docs/en/claude-code-on-the-web#resource-limits)
  * [Configure your environment](https://code.claude.com/docs/en/claude-code-on-the-web#configure-your-environment)
  * [Setup scripts](https://code.claude.com/docs/en/claude-code-on-the-web#setup-scripts)
  * [Environment caching](https://code.claude.com/docs/en/claude-code-on-the-web#environment-caching)
  ...
  * [Install dependencies with a SessionStart hook](https://code.claude.com/docs/en/claude-code-on-the-web#install-dependencies-with-a-sessionstart-hook)
  ...
  * [Allow specific domains](https://code.claude.com/docs/en/claude-code-on-the-web#allow-specific-domains)
  ...
  * [Move tasks between web and terminal](https://code.claude.com/docs/en/claude-code-on-the-web#move-tasks-between-web-and-terminal)
  * [From terminal to web](https://code.claude.com/docs/en/claude-code-on-the-web#from-terminal-to-web)
  * [Tips for cloud tasks](https://code.claude.com/docs/en/claude-code-on-the-web#tips-for-cloud-tasks)
  * [Send local repositories without GitHub](https://code.claude.com/docs/en/claude-code-on-the-web#send-local-repositories-without-github)
  * [From web to terminal](https://code.claude.com/docs/en/claude-code-on-the-web#from-web-to-terminal)
  * [Teleport requirements](https://code.claude.com/docs/en/claude-code-on-the-web#teleport-requirements)
  * [--teleport is unavailable](https://code.claude.com/docs/en/claude-code-on-the-web#teleport-is-unavailable)
  * [Work with sessions](https://code.claude.com/docs/en/claude-code-on-the-web#work-with-sessions)
  * [Manage context](https://code.claude.com/docs/en/claude-code-on-the-web#manage-context)
  * [Review changes](https://code.claude.com/docs/en/claude-code-on-the-web#review-changes)
  * [Share sessions](https://code.claude.com/docs/en/claude-code-on-the-web#share-sessions)
  * [Share from an Enterprise or Team account](https://code.claude.com/docs/en/claude-code-on-the-web#share-from-an-enterprise-or-team-account)
  * [Share from a Max or Pro account](https://code.claude.com/docs/en/claude-code-on-the-web#share-from-a-max-or-pro-account)
  * [Archive sessions](https://code.claude.com/docs/en/claude-code-on-the-web#archive-sessions)
  * [Delete sessions](https://code.claude.com/docs/en/claude-code-on-the-web#delete-sessions)
  ...
  * [Troubleshooting](https://code.claude.com/docs/en/claude-code-on-the-web#troubleshooting)
  * [Session creation failed](https://code.claude.com/docs/en/claude-code-on-the-web#session-creation-failed)
  * [Remote Control session expired or access denied](https://code.claude.com/docs/en/claude-code-on-the-web#remote-control-session-expired-or-access-denied)
...
This page covers:
  ...
  * [Move tasks between web and terminal](https://code.claude.com/docs/en/claude-code-on-the-web#move-tasks-between-web-and-terminal) with `--remote` and `--teleport`
...
| --- | --- | --- |  
| **GitHub App**  | Install the Claude GitHub App on specific repositories during [web onboarding](https://code.claude.com/docs/en/web-quickstart). Access is scoped per repository.  | Teams that want explicit per-repo authorization  |  
...
Organizations with [Zero Data Retention](https://code.claude.com/docs/en/zero-data-retention) enabled cannot use `/web-setup` or other cloud session features.
## 
...
### 
[​](https://code.claude.com/docs/en/claude-code-on-the-web#link-artifacts-back-to-the-session)
...
`--remote` creates cloud sessions. `--remote-control` is unrelated: it exposes a local CLI session for monitoring from the web. See [Remote Control](https://code.claude.com/docs/en/remote-control).
...
This pattern gives you control over the strategy while letting Claude execute autonomously in the cloud. **Plan in the cloud with ultraplan** : to draft and review the plan itself in a web session, use [ultraplan](https://code.claude.com/docs/en/ultraplan). Claude generates the plan on Claude Code on the web while you keep working, then you comment on sections in your browser and choose to execute remotely or send the plan back to your terminal. **Run tasks in parallel** : each `--remote` command creates its own cloud session that runs independently. You can start multiple tasks and they’ll all run simultaneously in separate sessions:
...
If a new session fails to start with `Session creation failed` or stalls at provisioning, Claude Code could not allocate a cloud environment.
  ...
  * Confirm your repository is reachable. Private repositories require either the GitHub App installed with access to that repository, or a `gh` token synced via `/web-setup`. See [GitHub authentication options](https://code.claude.com/docs/en/claude-code-on-the-web#github-authentication-options).
...
Terms and policies
[Privacy choices](https://code.claude.com/docs/en/claude-code-on-the-web)[Privacy policy](https://www.anthropic.com/legal/privacy)[Disclosure policy](https://www.anthropic.com/responsible-disclosure-policy)[Usage policy](https://www.anthropic.com/legal/aup)[Commercial terms](https://www.anthropic.com/legal/commercial-terms)[Consumer terms](https://www.anthropic.com/legal/consumer-terms)
Assistant
